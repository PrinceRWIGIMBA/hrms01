                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="depart" type="text" class="form-control border-input" name="department_name">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="content table-responsive table-full-width">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach ($department as $key=> $job_title)
                                        <tr>
                                            <td>{{$key+1}}</td>
                                            <td> {{ $job_title->department_name }} </td>
                                            <td> {{ $job_title->description }} </td>
                                            <td>
                                                <a href="/Depart/edit/{{Crypt::encrypt($job_title->id)}}" style="color:blue">edit</a> |
                                                <a href="#!" onclick="document.getElementById('delete-{{$job_title->id}}').submit()"
                                                             style="color:red">Delete</a>
                                                <form action="/depart/delete/{{Crypt::encrypt($job_title->id)}}"
                                                      method="post"
